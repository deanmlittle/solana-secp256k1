...
mod tests {
    ...
    #[test]
    fn mod_inv_n() {
        let x = Curve::mod_inv_n(&ODD_COMPRESSED.x()).unwrap();
        assert_eq!(
            x,
            [
    ...
    fn mod_add_n() {
        ...
        assert_eq!(Curve::add_mod_n(&a, &Curve::N), a)
    }

    #[test]
    fn mod_add_p() {
        let a = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01];
        assert_eq!(Curve::add_mod_p(&a, &a), [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02]);
        assert_eq!(Curve::add_mod_p(&a, &Curve::P), a)
    }
    ...
    #[test]
    fn tweak_compressed_pubkey() {
        let pubkey = CompressedPoint([0x02, 0x79, 0xbe, 0x66, 0x7e, 0xf9, 0xdc, 0xbb, 0xac, 0x55, 0xa0, 0x62, 0x95, 0xce, 0x87, 0x0b, 0x07, 0x02, 0x9b, 0xfc, 0xdb, 0x2d, 0xce, 0x28, 0xd9, 0x59, 0xf2, 0x81, 0x5b, 0x16, 0xf8, 0x17, 0x98]);
        let tweak = [0x3c, 0xf5, 0x21, 0x6d, 0x47, 0x6a, 0x5e, 0x63, 0x7b, 0xf0, 0xda, 0x67, 0x4e, 0x50, 0xdd, 0xf5, 0x5c, 0x40, 0x32, 0x70, 0xdd, 0x36, 0x49, 0x4d, 0xfc, 0xca, 0x43, 0x81, 0x32, 0xfa, 0x30, 0xe7];
        let tweaked = pubkey.tweak(tweak).unwrap();
        assert_eq!(tweaked.x(), [0xda, 0x47, 0x10, 0x96, 0x4f, 0x78, 0x52, 0x69, 0x5d, 0xe2, 0xda, 0x02, 0x52, 0x90, 0xe2, 0x4a, 0xf6, 0xd8, 0xc2, 0x81, 0xde, 0x5a, 0x0b, 0x90, 0x2b, 0x71, 0x35, 0xfd, 0x9f, 0xd7, 0x4d, 0x21]);
    }
